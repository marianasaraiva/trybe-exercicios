...
console.log(`Trapezio de base Maior 100cm, base Menor 70cm e altura 50cm: ${Exercise.trapezio(100, 70, 50)}cm²`);
console.log(`Trapezio de base Maior 75cm, base Menor 50cm e altura 35cm: ${Exercise.trapezio(75, 50, 35)}cm²`);
console.log(`Trapezio de base Maior 150cm, base Menor 120cm e altura 80cm: ${Exercise.trapezio(150, 120, 80)}cm²`);
