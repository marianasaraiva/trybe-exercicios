...
# (soma, subtração, multiplicação, divisão, divisão inteira, potenciação
# e módulo) envolvendo essas variáveis.
a = 10
b = 5
a + b
a - b
...
# Quantos minutos tem em 6 horas?
# E quantos segundos?
...
# Assim como em JavaScript, Python permite que você coloque um ponto e vírgula
# no final de uma instrução.
...
# método set(). Inicialize uma variável com essa função var = set()
...
# Exercícios de fixação 8, 9 e 10:
info = {
...
# estes valores.
# Resposta: A estrutura recomendada é a tuple. Caso houvesse necessidade de
...
# Resposta: dict é a estrutura mais adequada, pois conseguimos armazenar o
# elemento da lista como chave e a quantidade de vezes que ele aparece como
# valor da chave.
my_list = [20, 20, 1, 2]
...
# counter++. Da mesma forma, poderíamos ter atualizado o resultado com a
# expressão result *= counter.
...
# Exercício 14: Percorra a lista do exercício 13 e imprima "Múltiplo de 3" se
